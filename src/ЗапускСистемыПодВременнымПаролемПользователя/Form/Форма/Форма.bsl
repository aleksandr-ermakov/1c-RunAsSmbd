...
&НаКлиенте
Процедура ЗапуститьСистемуБезПодменыПароля(Команда)
...
&НаКлиенте
Процедура ЗапуститьСеанс(ИспользоватьВременныйПароль)
	...
	ПараметрыКоманднойСтроки = ПараметрыКоманднойСтроки(ИспользоватьВременныйПароль);
...
//  Строка
//
Функция ПараметрыКоманднойСтроки(ИспользоватьВременныйПароль = Истина)
